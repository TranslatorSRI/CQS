...
paths=("$BASE_URL/Path_A/Path_A_e0-e1-e2-allowlist.json,n0,path_a.template.json", "$BASE_URL/Path_B/Path_B_TRAPI.json,n0,path_b.template.json", "$BASE_URL/Path_E/path_e_query.json,n1,path_e.template.json")
for i in ${paths[@]}; do
